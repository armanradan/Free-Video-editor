...
Status: design researched 2026-09-15; M3.5 acceptance passed on 2026-09-21 for Firefox's enabled WebM profiles and all three profiles in Chromium. See [interop-report.md](interop-report.md) for milestone-specific evidence and limitations. M3.6 has not started.
